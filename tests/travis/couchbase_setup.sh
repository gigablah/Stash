...
/opt/couchbase/bin/couchbase-cli bucket-create -c 127.0.0.1:8091 --bucket=test --bucket-type=couchbase --bucket-port=11212 --bucket-ramsize=100 --bucket-replica=0 -u Administrator -p password
