...
curl -X POST -H 'Content-type: application/json' -u Administrator:password -d authType=none -d bucketType=couchbase -d name=test -d flushEnabled=1 -d ramQuotaMB=100 http://127.0.0.1:8091/pools/default/buckets
